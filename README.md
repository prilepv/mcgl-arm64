<p align="center">
  <img src="native-launcher/Assets/app-icon.png" width="144" alt="Minecraft Galaxy ARM64">
</p>

<h1 align="center">Minecraft Galaxy ARM64</h1>

<p align="center">
  Неофициальный нативный порт для Apple Silicon · версия 1.6.5
</p>

<p align="center">
  <a href="https://github.com/prilepv/mcgl-arm64/releases/latest"><strong>Скачать последнюю версию</strong></a>
  ·
  <a href="docs/RELEASE-NOTES-1.6.5.md">Что изменилось</a>
  ·
...
- В 1.6.5 — новый интерфейс, собственные фон/иконка и исправление прозрачных блоков.
...
Это снимок собственных исходников порта 1.6.5 и изменённых файлов LWJGL.
...
[заметки к 1.6.5](docs/RELEASE-NOTES-1.6.5.md).
