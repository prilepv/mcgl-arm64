...
<p align="center">
  Неофициальный нативный порт для Apple Silicon · 1.7.0
...
<p align="center">
  ...
  · <a href="docs/RELEASE-NOTES-1.7.0.md">Что нового</a>
...
## 1.7.0 — новый графический фундамент
...
и запустите 1.7.0. Установка остаётся ручной: приложение не перезаписывает себя.
...
Если уже установлена локальная 1.7.0, ту же версию загрузите вручную.
...
История: [1.7.0](docs/RELEASE-NOTES-1.7.0.md) · [1.6.7](docs/RELEASE-NOTES-1.6.7.md) ·
