...
<p align="center">
  Неофициальный нативный порт для Apple Silicon · 1.7.2
...
<p align="center">
  ...
  · <a href="docs/RELEASE-NOTES-1.7.2.md">Что нового</a>
...
![Лаунчер 1.7.2 — Играть](docs/screenshots/1.7.2/launcher-play.png)

## 1.7.2 — оптимизация отрисовки

- **Крупнее пакеты мира:** совместимые материалы и текстуры отправляются
  меньшим числом отдельных вызовов, в исходном порядке.
- **Ускорены геометрия и модели:** меньше промежуточных копирований,
  ограниченное объединение совместимых частей и более ёмкое размещение на GPU.
- **Облегчённые шейдеры для проходов без освещения** и меньше лишних
  переключений состояния, без снижения качества, дальности и шрифтов.
- **Настройки и аккаунты сохраняются.** Исправление осадков и пакетный текст
  из 1.7.1 включены; неподдерживаемые случаи используют совместимый путь.

[Подробности изменений и ограничения](docs/RELEASE-NOTES-1.7.2.md).
Выпуск основан на принятой сборке 196; фиксированный FPS не обещается.
...
![Краткая история релизов в лаунчере](docs/screenshots/1.7.2/launcher-changes.png)

<details>
<summary>Аккаунты, настройки и журнал</summary>

![Менеджер аккаунтов](docs/screenshots/1.7.2/launcher-accounts.png)
![Настройки](docs/screenshots/1.7.2/launcher-settings.png)
![Журнал](docs/screenshots/1.7.2/launcher-log.png)
...
[Все изображения](docs/screenshots/1.7.2/README.md).
...
и запустите 1.7.2. Установка остаётся ручной: приложение не перезаписывает себя.
...
Публичные 1.7.0/1.7.1 и локальная 196 с номером 1.7.1 обнаруживают 1.7.2
как новую версию. Игровой код принятой локальной 196 при упаковке не изменён.
...
История: [1.7.2](docs/RELEASE-NOTES-1.7.2.md) · [1.7.1](docs/RELEASE-NOTES-1.7.1.md) · [1.7.0](docs/RELEASE-NOTES-1.7.0.md) · [1.6.7](docs/RELEASE-NOTES-1.6.7.md) ·
